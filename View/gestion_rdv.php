    ...
    <body class="pr-5 pl-5 ">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mr-auto p-1">
                    ...
                    <li class="nav-item active mr-3">
                        <a class="nav-link" href="#">Gestion des rendez-vous<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item mr-3">
        ...
        <div class="form-row ">
                    <div class="form-group col-md-4">
                        <button id="filtrerButton"type="button" class="btn btn-outline-primary"style=" margin: 0 auto;"> Lister les RDV d'une date </button>
                    </div>
                    <div class="form-group col-md-4">
                        <button class="btn btn-outline-primary"style=" margin: 0 auto;"><a href="?action=getRdv"> Lister Tous les RDV</a></button>
                    </div>
                    <div class="form-group col-md-4">
                        <button class="btn btn-outline-primary"style=" margin: 0 auto;"><a href="?action=getRdvToday">Afficher les RDV d'Aujourd'hui </a></button>
                    </div>
                </div>

        <br>
        <form id="filtrerForm"action="?action=filtrerDate"  method="POST" class="mt-4 shadow">
            <div class="container">
                <hr>
                <div class="form-group">
                    <label for="date"><b>Introduire une date </b></label>
                    <input type="date" placeholder="12-12-2012" class="form-control" name="date" required>
                </div>
                <div class="clearfix">
                    <button id="annulerFiltrer"type="button" class="btn btn-outline-danger" id="cancelForm1">Annuler</button>
