...
<html lang="en">
    ...
    <body class="pr-5 pl-5 ">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mr-auto p-1">
                    <li class="nav-item mr-3">
                        <a class="nav-link" href="?action=getPatient">Gestion des Patient</a>
                    </li>
                    <li class="nav-item  mr-3">
                        <a class="nav-link" href="?action=getRdv">Gestion des rendez-vous</a>
                    </li>
                    <li class="nav-item active mr-3">
                        <a class="nav-link" href="#">Ajouter un patient<span class="sr-only">(current)</span></a>
                    </li>
                </ul>
        ...
        <form action="?action=ajouterRdv"  method="POST" class="mt-4 shadow">
            <div class="container">
                <h1>  L'ajout d'un nouveau rendez-vous</h1>
                <p>Veuillez remplir ce formulaire pour ajouter un rendez-vous.</p>
                <hr>
                <p><b>Les information du patient</b></p>
                <div class="form-row ">
               ...
               <div class="form-group ">
                    ...
                    <input type="date" placeholder="12-12-2012" class="form-control" name="date_naissance" required>
                </div>
                <div class="form-row ">
                    <div class="form-group col-md-6">  
                        <label for="adresse"><b>Adresse </b></label>
                        <input type="text" placeholder="adresse" class="form-control" name="adresse" required>
                    </div>
                   <div class="form-group col-md-6">
                        <label for="telephone"><b>Telephone </b></label>
                        <input type="tel" placeholder="00 00 00 00 00" class="form-control" name="telephone" required>
                    </div>
                </div>
                    <div class="form-group">
                        <label for="email"><b>Email</b></label>
                        <input type="email" class="form-control"aria-describedby="emailHelp" placeholder="name@example.com" name="email" required>
                    </div>
                
                <div class="form-group "> 
                    <label for="info"><b>Information Médicale</b></label>
                    <textarea type="text" class="form-control" name="info" rows="3" required>
                    </textarea>
                </div>
                <br><br>
                <p><b>Les information du rendez-vous</b></p>
                <div class="form-row">
                    <div class="form-group col-md-6">
                ...
                <div class="row">
                    <div class="col-12 col-md">
                        <ul class="listf p-1 d-flex mt-3">
                            <li class="mr-3">
                                <a  href="?action=getPatient">Gestion des Patient</a>
                            </li>
                            <li class="  mr-3">
